...
export default function FollowedScreen() {
            ...
            articles: [
                {
                    ...
                    image: "https://cdn.lesnumeriques.com/optim/images/logo-LN-rss.png",
                    description: "...",
                },
                {
                    id: "a2",
    ...
    const renderUserSection = ({ item }) => {
        const fakeCategoryObj = {
            //pas le choix sinon je peux pas reprendre ArticlesSection
            _id: item._id,
            name: item.username,
