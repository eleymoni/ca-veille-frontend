...
export const categoriesUniqueFeed = [
    {
        _id: "cat1",
        name: "Technologie fdsdfdsf ds ds fdsf dsfdsf sdf ds sd fsd g fhghfghfhfhfgfsd",
        color: "#FF5733",
        ownerId: "user123",
        articles: [
            {
        ...
        articles: [
            {
                ...
                url: "https://santenews.fr/bien-manger",
                title: "Bien manger pour mieux vivre",
                description: "Conseils nutritionnels pour rester en forme.",
                media: null,
                date: new Date("2025-03-30"),
                author: "Dr. Isabelle",
                defaultMedia:
